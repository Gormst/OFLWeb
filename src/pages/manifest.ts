...
export type PageKey = 'admin' | 'article' | 'authRedirect' | 'boxScore' | 'connect' | 'home' | 'mediaEditor' | 'media' | 'players' | 'privacyPolicy' | 'profile' | 'schedule' | 'standings' | 'stats' | 'teams' | 'termsOfService';
