...
export function GlobalLiveMiniViewer({ pathname }: GlobalLiveMiniViewerProps) {
  ...
  return (
    <>
      <style>{`
        .global-live-mini{position:fixed;right:22px;bottom:22px;width:min(560px,calc(100vw - 44px));background:var(--paper);color:var(--navy);border:1px solid var(--line-strong);box-shadow:0 20px 50px rgba(0,0,0,.42);z-index:3000;}
        .global-live-mini-head{display:flex;align-items:center;justify-content:space-between;gap:10px;background:var(--paper-2);border-top:4px solid var(--red,#9F3622);padding:10px 12px;}
        ...
        .global-live-mini-live{font-family:'Space Mono';font-size:12px;letter-spacing:1.5px;background:var(--red,#9F3622);color:#fff;border-radius:999px;padding:5px 7px;white-space:nowrap;}
        ...
        .global-live-mini-quad{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1px;background:var(--line-strong);}
        .global-live-mini-quad-cell{background:#000;min-width:0;}
        .global-live-mini-quad-label{font-family:'Space Mono';font-size:12px;letter-spacing:1px;text-transform:uppercase;color:var(--navy);background:var(--paper-2);padding:6px 8px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
        ...
        .global-live-mini-quad-empty{aspect-ratio:16/9;display:flex;align-items:center;justify-content:center;color:var(--muted);font-family:'Space Mono';font-size:12px;letter-spacing:1px;text-transform:uppercase;background:var(--paper-2);}
